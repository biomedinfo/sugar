...
public class FastBAMSequence extends Sequence implements SAMInfo{

	protected String samRecord;
	protected int mappingQuality;

	public FastBAMSequence(SequenceFile file, String sequence, String quality,
			String id, int mappingQuality, String record) {
