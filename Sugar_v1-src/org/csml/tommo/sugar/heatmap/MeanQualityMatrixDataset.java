...
public class MeanQualityMatrixDataset implements XYZDataset {

	protected MeanQualityMatrix matrix;
	
	public MeanQualityMatrixDataset(MeanQualityMatrix matrix){
		super();
		this.matrix = matrix;
	}
    ...
    public MeanQualityMatrix getMeanQualityMatrix() {
    	return matrix;
    }
}
