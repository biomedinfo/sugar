...
public class DiffOperation extends AbstractMixOperation {

	public DiffOperation(){
		super();
	}
	
	public DiffOperation(double param){
		super(param);
	}
	...
	public PaintScale getPaintScale() {
		return new TemperaturePaintScale(-QualityHeatMapsPerTileAndBase.MAX_LOWQ_READS_RATIO, QualityHeatMapsPerTileAndBase.MAX_LOWQ_READS_RATIO);
	}
}
