...
public class AbsoluteDiffOperation extends DiffOperation {

	public AbsoluteDiffOperation(){
		super();
	}
	
	public AbsoluteDiffOperation(double param){
		super(param);
	}
	...
	public PaintScale getPaintScale() {
		return new TemperaturePaintScale(0d, QualityHeatMapsPerTileAndBase.MAX_LOWQ_READS_RATIO);
	}
}
