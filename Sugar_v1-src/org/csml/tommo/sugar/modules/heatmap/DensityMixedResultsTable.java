...
public class DensityMixedResultsTable extends DensityResultsTable {
	 ...
	 * @param arg0
	 */
	public DensityMixedResultsTable(QualityHeatMapsPerTileAndBase qualityHeatMapsPerTileAndBase, DensityMixedResultsTableModel model) {
		super(qualityHeatMapsPerTileAndBase, model);
	}

	@Override
	public DensityMixedResultsTableModel getModel() {
		return (DensityMixedResultsTableModel) super.getModel();
	}
	...
	public void updateModel(LaneCoordinates laneCoordinates) {			
		DensityMixedResultsTableModel model = new DensityMixedResultsTableModel(qualityHeatMapsPerTileAndBase, laneCoordinates, getModel().getTileNumeration());			
		setModel(model);	
