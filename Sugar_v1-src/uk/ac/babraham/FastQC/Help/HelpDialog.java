...
public class HelpDialog extends JDialog implements TreeSelectionListener {
	 ...
	 */
	public HelpDialog (JFrame parent, String startingLocation) {
		super(parent,"Help Contents");
				
		File startDir = ResourceUtils.extractHelpPackage(startingLocation);
		
		HelpIndexRoot root = new HelpIndexRoot(startDir);
...
//		setSize(800,500);
	...
	private void findStartingPage () {
		...
		TreeNode tn = currentNode.getFirstChild();
