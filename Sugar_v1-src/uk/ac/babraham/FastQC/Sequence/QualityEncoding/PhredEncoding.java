...
public class PhredEncoding implements Serializable {
	...
	public int char2QualityScore (char c)
	{
		return (offset == SANGER_ENCODING_OFFSET) ?
			c - SANGER_ENCODING_OFFSET :
			c - ILLUMINA_1_3_ENCODING_OFFSET;						
	}
