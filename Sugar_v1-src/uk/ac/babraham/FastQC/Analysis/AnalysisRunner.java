...
public class AnalysisRunner implements Runnable {
	...
	protected SequenceFile file;
	protected QCModule [] modules;
	protected List<AnalysisListener> listeners = new ArrayList<AnalysisListener>();
...
//				System.out.println(modules[m].getClass().getName() + ".processSequence(" + seqCount + ")");
			}
